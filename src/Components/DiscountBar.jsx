...
export const DiscountBar = () => {
    ...
    return <div className="w-full flex bg-black text-white py-2 text-xs text-center justify-center items-center">

        <div className="font-satoshi text-sm sm:text-lg">
